...
class student(person):
    def __init__(self, firstname='Robertus', lastname='Chris', gender='male', age=69, country='indonesia', city='surabaya'):
        self.gender = gender
        super().__init__(firstname, lastname, gender, age, country, city)
...
s1 = student()
s2 = student('Anu', 'Itu', None, 69, 'japan', 'tokyo') #all arguments need to have value.
